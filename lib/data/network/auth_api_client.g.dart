...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<BaseResponse<void>> register(RegisterRequest request) async {
  ...
  @override
  Future<BaseResponse<void>> logout(RefreshTokenRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse<void>> withdraw(Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
